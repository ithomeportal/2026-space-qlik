...
import type { AdminAccessTrendPoint } from "@/lib/admin-access-api"
import { fmtDate } from "@/lib/admin-access-api"

interface Props {
  points: AdminAccessTrendPoint[]
}
  ...
  return (
    <div className="relative">
      <div className="mb-1 flex items-center gap-4 text-[10px] text-[#374151]">
        ...
        <span className="ml-auto text-[#9CA3AF]">Admin · rolling 30 days · ignores date filter</span>
      </div>
