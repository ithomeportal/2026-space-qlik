...
import type { DfwAccessTrendPoint } from "@/lib/dfw-access-api"
import { fmtDate } from "@/lib/dfw-access-api"

interface Props {
  points: DfwAccessTrendPoint[]
}
...
export function DfwTrendChart({ points }: Props) {
  ...
  return (
    <div className="relative">
      <div className="mb-1 flex items-center gap-4 text-[10px] text-[#374151]">
        ...
        <span className="ml-auto text-[#9CA3AF]">Operations (DFW) · rolling 30 days · ignores date filter</span>
      </div>
