...
import type { DfwAccessJobTitleBar } from "@/lib/dfw-access-api"

interface Props {
  rows: DfwAccessJobTitleBar[]
}
  ...
  return (
    <div className="rounded-lg border border-[#E5E7EB] bg-white p-3">
      <div className="mb-2 flex items-center gap-4 text-[10px] text-[#374151]">
        ...
        <span className="ml-auto text-[#9CA3AF]">Operations (DFW) · ignores job-title filter</span>
      </div>
