...
function KpiCard({
  ...
  return (
    <div className="rounded-md border border-[#A7F3D0] bg-[#F0FDF4] p-2">
      <div className="text-[10px] uppercase tracking-wide text-[#065F46]">
        {title}
      </div>
      <div className="mt-1 grid grid-cols-3 gap-2">
        <div>
          <div className="text-[9px] text-[#065F46]">Orders</div>
          <div className="text-sm font-semibold text-[#111827] tabular-nums">
            {fmtCount(orders)}
          </div>
        </div>
        <div>
          <div className="text-[9px] text-[#065F46]">Service Fail</div>
          <div className="text-sm font-semibold text-[#DC2626] tabular-nums">
            {fmtCount(fail)}
          </div>
        </div>
        <div>
          <div className="text-[9px] text-[#065F46]">% On Time</div>
...
function FilteredKpiCard({
  ...
  return (
    <div className="rounded-md border border-[#A7F3D0] bg-[#F0FDF4] p-2 text-center">
      <div className="text-[10px] uppercase tracking-wide text-[#065F46]">
...
export function DelOverview({ filters }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Top row: 3 pinned KPI cards + filtered KPI card */}
