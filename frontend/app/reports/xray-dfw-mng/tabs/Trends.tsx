...
export function Trends({ filters }: Props) {
  ...
  return (
    <div className="space-y-6">
      <XrayDfwErrorBanner label="Trends" errors={[trendsErr, summErr]} />
      <ChartCard
...
function BarChartWithAvg({
  ...
  data: XrayDfwTrendPoint[]
  dataKey: keyof XrayDfwTrendPoint
  color: string
  avg?: number
  avgTM?: number
